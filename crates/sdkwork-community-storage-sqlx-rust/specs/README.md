...
This directory is the local SDKWork component contract for `sdkwork-community-storage-sqlx-rust`.

- Component root: `sdkwork-community/crates/sdkwork-community-storage-sqlx-rust`
