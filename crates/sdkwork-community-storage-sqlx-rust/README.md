...
This README is the SDKWork module entrypoint for `sdkwork-community-storage-sqlx-rust`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
