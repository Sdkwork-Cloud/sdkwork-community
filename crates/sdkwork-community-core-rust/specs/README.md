...
This directory is the local SDKWork component contract for `sdkwork-community-core-rust`.

- Component root: `sdkwork-community/crates/sdkwork-community-core-rust`
