...
This directory is the local SDKWork component contract for `sdkwork-community-http-rust`.

- Component root: `sdkwork-community/crates/sdkwork-community-http-rust`
