...
This directory is the local SDKWork component contract for `@sdkwork/community-backend-sdk-workspace`.

- Component root: `sdkwork-community/sdks/sdkwork-community-backend-sdk`
