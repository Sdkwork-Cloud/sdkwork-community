...
This README is the SDKWork module entrypoint for `sdkwork-community-backend-sdk`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `node tools/community_sdk_generate.mjs --check`
- `node sdks/sdkwork-community-backend-sdk/bin/generate-sdk.mjs`
