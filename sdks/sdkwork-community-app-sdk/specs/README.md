...
This directory is the local SDKWork component contract for `@sdkwork/community-app-sdk-workspace`.

- Component root: `sdkwork-community/sdks/sdkwork-community-app-sdk`
