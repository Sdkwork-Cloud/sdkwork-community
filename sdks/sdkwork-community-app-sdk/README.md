...
This README is the SDKWork module entrypoint for `sdkwork-community-app-sdk`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `node sdks/sdkwork-community-app-sdk/bin/generate-sdk.mjs`
