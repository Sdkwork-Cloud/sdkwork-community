...
export class CommunityEntriesPublicBySlugApi {
...
export class CommunityEntriesPublicApi {
  private client: HttpClient;
...
export interface CommunityFeedPublicListParams {
  categoryId?: string;
  kind?: string;
  q?: string;
  reviewState?: string;
...
export class CommunityFeedPublicApi {
  private client: HttpClient;
...
export class CommunityCategoriesPublicApi {
  private client: HttpClient;
