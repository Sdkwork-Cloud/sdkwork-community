...
This directory is the local SDKWork component contract for `@sdkwork/community-sdk-ports`.

- Component root: `sdkwork-community/packages/common/community/sdkwork-community-sdk-ports`
