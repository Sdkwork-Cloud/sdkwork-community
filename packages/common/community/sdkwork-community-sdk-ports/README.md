...
Capability: community-sdk-ports
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/community-sdk-ports`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
