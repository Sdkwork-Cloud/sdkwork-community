...
This directory is the local SDKWork component contract for `@sdkwork/community-contracts`.

- Component root: `sdkwork-community/packages/common/community/sdkwork-community-contracts`
