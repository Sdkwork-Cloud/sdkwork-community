...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_community_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'community_', owner: 'community-platform', domain: 'community' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into community database contract\n`);
