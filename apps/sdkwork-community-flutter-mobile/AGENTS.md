# Flutter Mobile Application Agent Instructions
...
This is a Flutter mobile application root for the community product. It follows `FLUTTER_APP_MOBILE_ARCHITECTURE_SPEC.md` for application architecture.

## Local Dictionary Structure

- `AGENTS.md`: local agent entrypoint and relative SDKWORK spec index.
- `sdkwork.app.config.json`: application manifest for Flutter mobile deployment.
...
- `pubspec.yaml`: Flutter/Dart build manifest.
- Local directories to inspect first when relevant: `packages/`, `lib/`, `config/`, `scripts/`.
...
- Flutter mobile application changes: `../../sdkwork-specs/FLUTTER_APP_MOBILE_ARCHITECTURE_SPEC.md`, `../../sdkwork-specs/APP_FLUTTER_UI_SPEC.md`
...
- Dart/Flutter code: `../../sdkwork-specs/FRONTEND_CODE_SPEC.md`, `../../sdkwork-specs/FRONTEND_SPEC.md`, `../../sdkwork-specs/UI_ARCHITECTURE_SPEC.md`.
