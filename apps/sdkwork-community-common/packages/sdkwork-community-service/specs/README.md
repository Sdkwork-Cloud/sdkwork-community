...
This directory is the local SDKWork component contract for `@sdkwork/community-service`.

- Component root: `sdkwork-community/packages/common/community/sdkwork-community-service`
