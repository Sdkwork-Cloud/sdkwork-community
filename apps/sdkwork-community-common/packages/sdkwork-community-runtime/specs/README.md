...
This directory is the local SDKWork component contract for `@sdkwork/community-runtime`.

- Component root: `sdkwork-community/packages/common/community/sdkwork-community-runtime`
