...
export const COMMUNITY_BACKEND_API_ROUTES: readonly SdkworkCommunityApiRoute[] = [
  ...
  route("PATCH", "/backend/v3/api/community/circles/{categoryId}", "circles.update", false),
  route("GET", "/backend/v3/api/community/entries", "entries.management.list", false),
  route("POST", "/backend/v3/api/community/entries/{entryId}/moderation", "entries.moderation.create", false),
  ...
  route("GET", "/backend/v3/api/community/members", "members.management.list", false),
  route("PATCH", "/backend/v3/api/community/members/{memberId}", "members.update", false),
  route("DELETE", "/backend/v3/api/community/members/{memberId}", "members.delete", false),
  route("GET", "/backend/v3/api/community/groups", "groups.management.list", false),
  route("POST", "/backend/v3/api/community/groups", "groups.create", false),
  route("PATCH", "/backend/v3/api/community/groups/{groupId}", "groups.update", false),
  route("DELETE", "/backend/v3/api/community/groups/{groupId}", "groups.delete", false),
  route("GET", "/backend/v3/api/community/tiers", "tiers.management.list", false),
  route("POST", "/backend/v3/api/community/tiers", "tiers.create", false),
  route("PATCH", "/backend/v3/api/community/tiers/{tierId}", "tiers.update", false),
  route("DELETE", "/backend/v3/api/community/tiers/{tierId}", "tiers.delete", false),
  route("POST", "/backend/v3/api/community/tiers/{tierId}/publish", "tiers.publish", false),
  route("POST", "/backend/v3/api/community/tiers/{tierId}/unpublish", "tiers.unpublish", false),
];
